...
export default function List({ propagateServerField, children }: any) {
    return (
        <div className="w-full max-w-full sm:max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg xl:max-w-[1250px] 2xl:max-w-screen-2xl border border-gray-700 rounded-lg p-4 bg-gray-900 overflow-hidden">
